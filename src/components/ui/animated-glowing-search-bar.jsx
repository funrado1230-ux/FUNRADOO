...
export const SearchComponent = ({ value, onChange, onFocus, onBlur, placeholder = "Search for products..." }) => {
  return (
      ...
      <div id="poda" className="relative flex items-center justify-center group">
        ...
        <div id="main" className="relative group">
          <input 
            ...
            onFocus={onFocus}
            onBlur={onBlur}
            className="bg-[#010201] border-none w-[301px] h-[56px] rounded-lg text-white px-[59px] text-sm sm:text-base focus:outline-none placeholder-gray-400 font-medium" 
          />
          ...
          {/* Filter Icon */}
          <div id="filter-icon" className="absolute top-2 right-2 flex items-center justify-center z-[2] max-h-10 max-w-[38px] h-full w-full [isolation:isolate] overflow-hidden rounded-lg bg-gradient-to-b from-[#161329] via-black to-[#1d1b4b] border border-transparent cursor-pointer">
